...
# Other
sudo pacman -S zsh-syntax-highlighting zsh-autosuggestions zsh zsh-completions starship xplr neovim base-devel alacritty  fuse ntfs-3g firefox nodejs nitrogen fzf ripgrep the_silver_searcher fd gvfs
